...
public class Mastermind {
	...
	public static String nextGuess(String[] combos, boolean[] verdict, String guess, int goodIndex, int wrongIndex)
	{
		...
		System.out.println("Your next guess should be: " +combos[index]);
		return combos[index];
	}
	...
	public static void main(String[] args) {
		...
		do {
			...
			//nextGuess(combos, verdict, guess, goodIndex, wrongIndex);
			...
			do {
				goodInput = true;
				//guess = input.next();
				guess = nextGuess(combos, verdict, guess, goodIndex, wrongIndex);
